...
public class Cone extends LaserControl {
  ...
  public static final LXVector TOWARD_MOUNTAINS =
      new LXVector(-1, Cone.SPIN_RADIUS_RATIO, 0).normalize();
  ...
  public Cone(TELaserModel laser) {
    ...
    float ecks =
        homeDirection.x; // Avoid an annoying warning about passing "x" to a parameter called y
