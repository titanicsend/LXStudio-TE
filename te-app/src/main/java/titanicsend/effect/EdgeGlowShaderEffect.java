...
public class EdgeGlowShaderEffect extends GLShaderEffect {
  ...
  public final BoundedParameter edgeThreshold =
      new BoundedParameter("Threshold", 0.15, 0.0, 1.0).setDescription("Edge magnitude threshold");
  ...
  public final CompoundParameter mix =
      new CompoundParameter("Mix", 1.0, 0.0, 1.0).setDescription("Blend of the effect over source");
