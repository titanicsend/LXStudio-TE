...
public class PanelAdjustEffect extends TEEffect
  ...
  public final CompoundParameter xAdjust =
      new CompoundParameter("xAdjust", 0, -MAX_ADJUST, MAX_ADJUST);
  public final CompoundParameter yAdjust =
      new CompoundParameter("yAdjust", 0, -MAX_ADJUST, MAX_ADJUST);
  public final CompoundParameter zAdjust =
      new CompoundParameter("zAdjust", 0, -MAX_ADJUST, MAX_ADJUST);
  ...
  private static final Map<String, TEPanelModel.Adjustment> PANEL_ID_TO_ADJUSTMENT =
      new HashMap<>();
  ...
  public void onParameterChanged(LXParameter parameter) {
    if (parameter == this.panelIdParameter) {
      ...
      currentAdjustment =
          currentAdjustment != null ? currentAdjustment : new TEPanelModel.Adjustment();
  ...
  // Otherwise, when it loads the project file, it will set the controls back to the state when
  // saved
