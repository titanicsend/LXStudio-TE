...
public class KaleidoscopeShaderEffect extends GLShaderEffect {
  ...
  public final BoundedParameter segments =
      new BoundedParameter("Segments", 6, 1, 64)
          .setDescription("Number of kaleidoscope segments");
  ...
  public final CompoundParameter zoom =
      new CompoundParameter("Zoom", 1.0, 0.25, 4.0)
          .setDescription("Zoom of the texture sample");

  // Kaleidoscope center in normalized coords [0..1]
  public final BoundedParameter x =
      new BoundedParameter("X", 0.5, 0.0, 1.0)
          .setDescription("Kaleidoscope center X (normalized)");

  public final BoundedParameter y =
      new BoundedParameter("Y", 0.5, 0.0, 1.0)
          .setDescription("Kaleidoscope center Y (normalized)");
