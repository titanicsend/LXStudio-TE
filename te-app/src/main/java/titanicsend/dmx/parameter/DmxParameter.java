...
public interface DmxParameter extends LXNormalizedParameter {
  ...
  /**
   * Get value at a given alpha level. Only some DMX parameters (such as dimmer) will scale for
   * alpha.
   */
  ...
  /**
   * Get number of output bytes for this parameter. Most DMX parameters are 1 (8 bit) or 2 bytes (16
   * bit)
   */
  public int getNumBytes();

  /**
   * For now, have each parameter write its (limited) output value to the output array. Later will
   * remove this power from parameters.
   */
