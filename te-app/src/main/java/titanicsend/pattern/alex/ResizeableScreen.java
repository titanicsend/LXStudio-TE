...
// TODO: right now, we just color all pixels white. Soon, we should take a data array and color
// array
...
public class ResizeableScreen extends TEPattern implements UIDeviceControls<ResizeableScreen> {
  ...
  // Technically, we do have doubles, but the values are in microns, so if you really need a
  // fraction
  ...
  public final DiscreteParameter lowerYBoundParam =
      new DiscreteParameter(
              "Lower Y Bound",
              this.roundedLowerYLimit / 2,
              this.roundedLowerYLimit,
              this.roundedUpperYLimit)
          .setDescription("Lower boundary for the Y coordinate of the screen");
  public final DiscreteParameter upperYBoundParam =
      new DiscreteParameter(
              "Upper Y Bound",
              this.roundedUpperYLimit / 2,
              this.roundedLowerYLimit,
              this.roundedUpperYLimit)
