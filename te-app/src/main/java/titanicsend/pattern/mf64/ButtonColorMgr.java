...
public class ButtonColorMgr {
  ...
  /**
   * @return int array containing the colors associated with all currently pressed buttons. If no
   *     buttons are down, returns a single element array containing the color of the button that
   *     was most recently down.
   */
