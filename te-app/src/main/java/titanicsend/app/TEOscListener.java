 ...
 *
 * <p>BPM and beats will be handled here, virtually identically to the way they are in LX
 * originally. Main reason for this is that ShowKontrol can only send to a single OSC port, and this
 * was simpler than taking a snapshot of the LX dev branch.
 *
 * <p>Also makes it very clear in our codebase which messages go to LX, and which go to TE. Mark
 * also confirmed this route was likely best for us at this time.
 */
