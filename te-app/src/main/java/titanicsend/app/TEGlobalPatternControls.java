...
public class TEGlobalPatternControls extends LXComponent {
  public final BooleanParameter useGlobalSpeed = new BooleanParameter("useSpeed", false);
  public final CompoundParameter globalSpeed = new CompoundParameter("Global Speed", 0.25, 0, 1);
