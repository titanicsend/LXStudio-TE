...
/**
 * A ChannelExtension is meant to be a singleton, adding a per-channel service to an LX instance.
 * This is similar to an effect that is always available on every channel.
 *
 * <p>(The ability to register a custom channel class with the engine would be a nicer way to solve
...
public abstract class ChannelExtension<T extends LXComponent> extends LXComponent {
  ...
  /** Early setup, gets called on child class BEFORE channels are added and T items are created. */
