...
public enum TEPanelSection {
  ...
  // The one standalone panel on the front (stage left) half of the starboard (stage) side of the
  // cart
  STARBOARD_FORE_SINGLE("Starboard Fore Single", "starboard-fore-single"),
  // The section of consecutive panels on the back (stage right) half of the starboard (stage) side
  // of the cart
  // Does not include the single panel
  STARBOARD_AFT("Starboard Aft", "starboard-aft"),
  // The one standalone panel on the front (stage right) half of the starboard (stage) side of the
  // cart
