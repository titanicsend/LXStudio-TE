...
import titanicsend.effect.PosterizeSolarizeShaderEffect;
...
import titanicsend.pattern.sinas.TasteOfNoise7;
...
public class TEApp extends LXStudio {
  ...
  public static class Plugin implements LXStudio.Plugin, LX.Listener, LX.ProjectListener {
    ...
    public void initialize(LX lx) {
      ...
      lx.registry.addPattern(TasteOfNoise7.class);
  ...
  lx.registry.addEffect(EdgeGlowShaderEffect.class);
  lx.registry.addEffect(HueOrbitShaderEffect.class);
  lx.registry.addEffect(KaleidoscopeShaderEffect.class);
  lx.registry.addEffect(PosterizeSolarizeShaderEffect.class);
  lx.registry.addEffect(StrobeShaderEffect.class);
      lx.registry.addEffect(PixelizationShaderEffect.class);
