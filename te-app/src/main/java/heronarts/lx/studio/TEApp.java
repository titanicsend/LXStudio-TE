...
import titanicsend.effect.ShaderEdgeGlow;
import titanicsend.effect.ShaderHueOrbit;
import titanicsend.effect.ShaderKaleidoscope;
import titanicsend.effect.ShaderPosterizeSolarize;
import titanicsend.effect.ShaderStrobe;
...
public class TEApp extends LXStudio {
  ...
  public static class Plugin implements LXStudio.Plugin, LX.Listener, LX.ProjectListener {
    ...
    public void initialize(LX lx) {
      ...
      lx.registry.addEffect(ShaderEdgeGlow.class);
      lx.registry.addEffect(ShaderHueOrbit.class);
      lx.registry.addEffect(ShaderKaleidoscope.class);
      lx.registry.addEffect(ShaderPosterizeSolarize.class);
      lx.registry.addEffect(ShaderStrobe.class);
