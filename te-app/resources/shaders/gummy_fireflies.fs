...
// #iUniform float stemDrums = 0.9 in {0.0, 1.0}
// #iUniform float stemVocals = 0.9 in {0.0, 1.0}
#iUniform float levelReact = 0.9 in {0.0, 1.0}
#iUniform float frequencyReact = 0.9 in {0.0, 1.0}
...
void mainImage(out vec4 fragColor, in vec2 fragC
oord) {
...
//     color = min(1.0,lit) * mix(iColorRGB, mix(iColorRGB, iColor2RGB, fract(lit)), colorMix);
