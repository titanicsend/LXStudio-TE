...
public abstract class TEPerformancePattern extends TEAudioPattern {
    ...
    public class TECommonControls {
        ...
        public void addCommonControls(TEPerformancePattern pat) {
            ...
            TEColorParameter colorParam = registerColorControl(pat, colorPrefix);
        ...
        public void buildDefaultControlList(TEPerformancePattern pat) {
            ...
            p = (LXListenableNormalizedParameter)new TECommonAngleParameter(pat, spinRotor, TEControlTag.ANGLE.getLabel(), 0, -Math.PI, Math.PI)
        ...
        protected TEColorParameter registerColorControl(TEPerformancePattern parentPattern, String prefix) {
            color = new TEColorParameter(parentPattern, prefix+"Color")
