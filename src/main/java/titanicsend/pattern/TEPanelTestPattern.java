...
public class TEPanelTestPattern extends TEPattern {
    ...
    public final ObjectParameter<String> target =
            (ObjectParameter<String>) new ObjectParameter<String>("Panel", new String[] {
                "FA", "FB", "FSA", "FSB", "FSC", "FPA", "FPB", "FPC", "AA", "AB", "ASA", "ASB", "ASC", "APA", "APB",
                "APC", "SFA", "SFB", "SEA", "SFC", "SFD", "SEB", "SEC", "SED", "SDA", "SDB", "SDC", "SEE", "SCA", "SCB",
                "SCC", "SBA", "SBB", "SBC", "SBD", "SBE", "SAA", "SAB", "SAC", "SAD", "SUF", "SUA", "PAA", "PAB", "PBA",
                "PAC", "PAD", "PBB", "PBC", "PBD", "PCA", "PCB", "PCC", "PBE", "PDA", "PDB", "PDC", "PEA", "PEB", "PEC",
