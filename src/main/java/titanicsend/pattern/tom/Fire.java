...
public class Fire extends TEPattern {
    ...
    private int calculateRows() {
        return (int) ((modelTE.boundaryPoints.maxYBoundaryPoint.y - modelTE.boundaryPoints.minYBoundaryPoint.y)
                        / ROW_HEIGHT)
                + 1;
    }

    private int calculateColumns() {
        return (int) ((modelTE.boundaryPoints.maxZBoundaryPoint.z - modelTE.boundaryPoints.minZBoundaryPoint.z)
                        / COLUMN_WIDTH)
                + 1;
    }
