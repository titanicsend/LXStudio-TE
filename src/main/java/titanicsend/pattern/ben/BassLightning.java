...
public class BassLightning extends TEAudioPattern {
    ...
    class Bolt {
        ...
        Bolt fork() {
            ...
            if (allowLoopsParam.getValueb()) {
                ...
                candidateEdges = new ArrayList<>(origin.edges.stream()
    ...
    public final DiscreteParameter energy = new DiscreteParameter("Energy", 3, 1, 11).setDescription("Amount of Bolts");
    public final CompoundParameter fadeParam = new CompoundParameter("Fade", .98, .95, .999);
    public final CompoundParameter delayParam = new CompoundParameter("Delay", 100, 1, 250);
    public final CompoundParameter lifeParam = new CompoundParameter("Life", 250, 1, 3000);
    public final CompoundParameter fixedDistanceParam =
            new CompoundParameter("Size", 50, 0, 200).setDescription("Bolt distance based on remaining life");
    public final CompoundParameter randomDistanceParam =
            new CompoundParameter("Vary", 50, 0, 200).setDescription("Random distance");
    ...
    public final BooleanParameter allowLoopsParam = new BooleanParameter("Loops", true)
