...
@LXCategory("Combo FG")
public class NeuralBeatRadialXY extends BaseCPPNPattern {

    public NeuralBeatRadialXY(LX lx) {
        super(lx);
    }
    ...
    protected int pointToColor(LXPoint point) {
        ...
        inputs = new double[] {x * (1 + swingBeat) + t1, y * (1 + swingBeat) + t1, r, r * (1 + swingBeat)};
