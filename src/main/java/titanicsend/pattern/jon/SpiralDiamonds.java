...
public class SpiralDiamonds extends TEPerformancePattern {
    ...
    public final CompoundParameter energy =
            new CompoundParameter("Energy", .1, 0, 1).setDescription("Ummm.... what does this button do?");

    public SpiralDiamonds(LX lx) {
        super(lx, TEShaderView.DOUBLE_LARGE);

        // Quantity controls density of diamonds
        controls.setRange(TEControlTag.QUANTITY, 4, 1, 7).setUnits(TEControlTag.QUANTITY, LXParameter.Units.INTEGER);
