...
public class TargetPixelStamper extends TEPattern {
  ...
  public final CompoundParameter size =
      new CompoundParameter("Size", 1, 0.1, 4).setDescription("Target size");

  public final EnumParameter<Side> side =
      new EnumParameter<>("Side", Side.STARBOARD).setDescription("Side of model");
  ...
  public final BooleanParameter stamp =
      new BooleanParameter("Stamp").setMode(BooleanParameter.Mode.MOMENTARY);
  public final BooleanParameter clear =
      new BooleanParameter("Clear").setMode(BooleanParameter.Mode.MOMENTARY);
