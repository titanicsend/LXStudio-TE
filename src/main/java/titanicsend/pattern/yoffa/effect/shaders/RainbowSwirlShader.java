...
public class RainbowSwirlShader extends FragmentShaderEffect {
    ...
    private final CompoundParameter bloom = new CompoundParameter("Bloom", 5, -0, 25).setDescription("Bloom");

    private final CompoundParameter zoom = new CompoundParameter("Zoom", 0, .7, 5).setDescription("Zoom");
