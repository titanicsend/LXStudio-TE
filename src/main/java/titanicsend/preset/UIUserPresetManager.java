...
public class UIUserPresetManager extends UICollapsibleSection {
  ...
  public UIUserPresetManager(UI ui, LXStudio lx, float w) {
    ...
    final UILabel fileName = (UILabel)
    ...
    UI2dContainer.newHorizontalContainer(18, BUTTON_SPACING,
        // New
        new UIButton(0, 0, buttonWidth, 18) {
          @Override
          public void onClick() {
            lx.showConfirmDialog("Clear current User Presets? Any unsaved changes will be lost.",
              engine::newLibrary
            );
          }
        }
        ...
        new UIButton(0, 0, buttonWidth, 18) {
          ...
          public void onClick() {
            ...
            lx.showConfirmDialog("Open User Presets file? Any unsaved changes will be lost.", () ->
    ...
    addListener(engine.libraryName, (p) -> {
