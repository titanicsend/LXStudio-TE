...
public class AdjStealthModel extends DmxModel {
    ...
    public static final String MODEL_TYPE = "DJLight";
    ...
    public static final int INDEX_SHUTTER = 7;
    public static final int INDEX_FOCUS = 8;
    public static final int INDEX_COLOR_TEMP = 9;
    public static final int INDEX_COLOR_EFFECT = 10;
    public static final int INDEX_COLOR_FADE = 11;
    public static final int INDEX_PT_SPEED = 12;
    public static final int INDEX_PROGRAMS = 13;
    ...
    public AdjStealthModel(DmxCommonConfig config, String... tags) {
        ...
        DmxCompoundParameter dimmer =
                new DmxCompoundParameter("Dimmer", 0, 0, 100).setScaleToAlpha(true); // Faders applied to this parameter
        ...
        DmxDiscreteParameter colorEffect = new DmxDiscreteParameter("ClrEffect", new DmxDiscreteParameterOption[] {
        ...
        DmxDiscreteParameter colorFade = new DmxDiscreteParameter("ClrFade", new DmxDiscreteParameterOption[] {
            new DmxDiscreteParameterOption("Nothing", 0), new DmxDiscreteParameterOption("Fade slow-fast", 11, 194)
        });
        DmxCompoundParameter ptSpeed = new DmxCompoundParameter("ptSpd");
        DmxDiscreteParameter programs = new DmxDiscreteParameter("Programs", new DmxDiscreteParameterOption[] {
            new DmxDiscreteParameterOption("Nothing", 0),
