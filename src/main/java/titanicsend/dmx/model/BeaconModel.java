...
public class BeaconModel extends DmxModel {
    ...
    public BeaconModel(DmxCommonConfig config, float tiltLimit, String... tags) {
        ...
        DmxCompoundParameter tilt = new DmxCompoundParameter("Tilt", TILT_MIN, TILT_MIN, TILT_MAX).setNumBytes(2);
        ...
        DmxCompoundParameter gobo1rotation = new DmxCompoundParameter("Gobo1 Rotation", 0, 0, 255).setNumBytes(2);
        // "Fixed Gobo"
        ...
        DmxCompoundParameter prism1rotation = new DmxCompoundParameter(
                        "Prism1 Rotation", new DmxDiscreteParameterOption[] {
                ...
                .setNumBytes(2);
        DmxCompoundParameter prism2rotation = new DmxCompoundParameter(
                        "Prism2 Rotation", new DmxDiscreteParameterOption[] {
                            new DmxDiscreteParameterOption("Indexing", 0, 127),
                            new DmxDiscreteParameterOption("CW rotate fast-slow", 128, 189),
                            new DmxDiscreteParameterOption("No rotate", 190, 193),
                            new DmxDiscreteParameterOption("CCW rotate slow-fast", 194, 255),
        ...
        DmxDiscreteParameter ptSpeed = new DmxDiscreteParameter("ptSpd", new DmxDiscreteParameterOption[] {
