...
public class BeaconModel extends DmxModel {
  ...
  static public final String MODEL_TYPE = "Beacon";
  ...
  static public final int INDEX_CYAN = 2;
  static public final int INDEX_MAGENTA = 3;
  static public final int INDEX_YELLOW = 4;
  static public final int INDEX_COLOR_WHEEL = 5;
  static public final int INDEX_GOBO1 = 6;
  static public final int INDEX_GOBO1_ROTATION = 7;
  static public final int INDEX_GOBO2 = 8;
  static public final int INDEX_PRISM1 = 9;
  static public final int INDEX_PRISM1_ROTATION = 10;
  static public final int INDEX_PRISM2_ROTATION = 11;
  static public final int INDEX_FOCUS = 12;
  static public final int INDEX_SHUTTER = 13;
  static public final int INDEX_DIMMER = 14;
  static public final int INDEX_FROST1 = 15;
  static public final int INDEX_FROST2 = 16;
  static public final int INDEX_PT_SPEED = 17;
  static public final int INDEX_CONTROL = 18;

  static public final int TILT_MIN = -124;
  static public final int TILT_MAX = 124;
  ...
  public BeaconModel(DmxCommonConfig config, float tiltLimit, String ... tags) {
    ...
    DmxCompoundParameter pan = new DmxCompoundParameter("Pan")
      .setNumBytes(2);
    DmxCompoundParameter tilt = new DmxCompoundParameter("Tilt", TILT_MIN, TILT_MIN, TILT_MAX)
      .setNumBytes(2);
    ...
    DmxDiscreteParameter ptSpeed = new DmxDiscreteParameter("ptSpd",
      new DmxDiscreteParameterOption[]     
