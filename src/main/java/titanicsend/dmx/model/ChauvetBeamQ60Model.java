...
public class ChauvetBeamQ60Model extends DmxModel {
    ...
    public static final String MODEL_TYPE = "ChauvetBeamQ60";
    ...
    public static final int INDEX_PAN_CONTINUOUS = 2;
    public static final int INDEX_TILT_CONTINUOUS = 3;
    public static final int INDEX_PT_SPEED = 4;
    ...
    public ChauvetBeamQ60Model(DmxCommonConfig config, String... tags) {
        ...
        DmxDiscreteParameter panContinuous =
                new DmxDiscreteParameter("PanContinuous", new DmxDiscreteParameterOption[] {
        ...
        DmxDiscreteParameter tiltContinuous =
                new DmxDiscreteParameter("TiltContinuous", new DmxDiscreteParameterOption[] {
                    new DmxDiscreteParameterOption("No Function", 0),
        ...
        DmxDiscreteParameter virtualColorWheelControl =
                new DmxDiscreteParameter("VCW Control", new DmxDiscreteParameterOption[] {
