...
public class ChauvetSpot160Model extends DmxModel {
    ...
    public static final String TE_MODEL_TYPE = "ChauvetSpot160";
    ...
    public static final int INDEX_PT_SPEED = 2;
    public static final int INDEX_COLOR_WHEEL = 3;
    public static final int INDEX_GOBO = 4;
    public static final int INDEX_DIMMER = 5;
    public static final int INDEX_SHUTTER = 6;
    public static final int INDEX_CONTROL = 7;
    public static final int INDEX_MOVEMENT_MACROS = 8;

    public static final int SHUTTER_CLOSED = 0;
    public static final int SHUTTER_OPEN = 4;
    public static final int SHUTTER_STROBE_MIN = 8;
    public static final int SHUTTER_STROBE_MAX = 76;
    ...
    public ChauvetSpot160Model(DmxCommonConfig config, String... tags) {
        ...
        DmxCompoundParameter tilt = new DmxCompoundParameter("Tilt", -130, -130, 114).setNumBytes(2);
        ...
        DmxDiscreteParameter gobo = new DmxDiscreteParameter("Gobo", new DmxDiscreteParameterOption[] {
        ...
        DmxDiscreteParameter movementMacros = new DmxDiscreteParameter("Movement", new DmxDiscreteParameterOption[] {
            new DmxDiscreteParameterOption("No Function", 0),
