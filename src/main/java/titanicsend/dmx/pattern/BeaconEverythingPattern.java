...
public class BeaconEverythingPattern extends BeaconPattern implements UIDeviceControls<BeaconEverythingPattern> {
    ...
    DmxDiscreteParameter colorWheelFixed =
            (DmxDiscreteParameter) new DmxDiscreteParameter("ClrWheel", new DmxDiscreteParameterOption[] {
    ...
    DmxDiscreteParameter gobo1Fixed =
            (DmxDiscreteParameter) new DmxDiscreteParameter("Gobo1", new DmxDiscreteParameterOption[] {
                new DmxDiscreteParameterOption("Open", 0),
    ...
    DmxDiscreteParameter gobo2Fixed =
            (DmxDiscreteParameter) new DmxDiscreteParameter("Gobo2", new DmxDiscreteParameterOption[] {
                new DmxDiscreteParameterOption("Open", 0),
