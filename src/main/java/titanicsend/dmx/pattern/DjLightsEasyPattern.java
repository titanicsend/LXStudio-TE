...
public class DjLightsEasyPattern extends DjLightsPattern implements UIDeviceControls<DjLightsEasyPattern> {
    ...
    public final BooleanParameter mirror = (BooleanParameter) new BooleanParameter("MIRROR", false)
            .setDescription("Alternates beam angle between fixtures")
            .setMode(Mode.MOMENTARY);

    public final BooleanParameter strobe = (BooleanParameter) new BooleanParameter("Strobe!", false)
            .setDescription("Press for strobe action!")
            .setMode(Mode.MOMENTARY);

    DiscreteParameter strobeSpeed =
            new DiscreteParameter("StrbSpd", 245, 10, 245).setWrappable(false).setDescription("Strobe Speed");
