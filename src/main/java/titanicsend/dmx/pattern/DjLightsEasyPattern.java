...
/**
 * Any easy pattern to use for controlling DJ lights. This might be sufficient for show time if
 * their position is mainly static.
 */
@LXCategory("DMX")
public class DjLightsEasyPattern extends DjLightsPattern
    implements UIDeviceControls<DjLightsEasyPattern> {
