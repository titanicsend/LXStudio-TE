...
public class UITEColorPicker extends UI2dComponent {
        ...
        switch (this.corner) {
            ...
            case TOP_LEFT:
                this.uiColorOverlay.setPosition(
                        this, overlap - this.uiColorOverlay.getWidth(), overlap - this.uiColorOverlay.getHeight());
                break;
            case TOP_RIGHT:
    ...
    protected class UITEColorOverlay extends UI2dContainer {
        ...
        UITEColorOverlay(UI ui, float width, float extraHeight) {
            ...
            // Horizontal break
            new UI2dComponent(PADDING, 140, this.width - 2 * PADDING, 1) {}.setBorderColor(ui.theme.controlBorderColor)
                    .addToContainer(this);
            ...
            UI2dContainer.newHorizontalContainer(
                            16,
                            1,
                            color1 = new UI2dComponent(0, 0, 16, 16) {}.setBorderColor(ui.theme.controlBorderColor)
                                    .setBackgroundColor(color.calcColor())
                                    .setBorderRounding(4),
                            new UISlider(UISlider.Direction.HORIZONTAL, 30, 16, color.color2offset).setShowLabel(false),
                            color2 = new UI2dComponent(0, 0, 16, 16) {}.setBorderColor(ui.theme.controlBorderColor)
        ...
        private class UISwatch extends UI2dComponent implements UIFocus {
            ...
            public void onDraw(UI ui, VGraphics vg) {
                ...
                vg.ellipse(GRID_X + hue / 360 * GRID_WIDTH, GRID_Y + (1 - saturation / 100) * GRID_HEIGHT, 4, 4);
                vg.stroke();
            ...
            public void onKeyPressed(KeyEvent keyEvent, char keyChar, int keyCode) {
                ...
                if (keyCode == java.awt.event.KeyEvent.VK_UP) {
                    keyEvent.consume();
                    getLX().command
                            .perform(new LXCommand.Parameter.SetValue(
                                    color.saturation, LXUtils.clampf(color.saturation.getBaseValuef() + inc, 0, 100)));
