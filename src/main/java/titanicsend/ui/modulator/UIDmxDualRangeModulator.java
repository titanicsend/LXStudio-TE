...
public class UIDmxDualRangeModulator implements UIModulatorControls<DmxDualRangeModulator> {
    ...
    public void buildModulatorControls(UI ui, UIModulator uiModulator, DmxDualRangeModulator modulator) {
        ...
        addColumn(inputs, 48, new UIIntegerBox(48, 16, modulator.universe), controlLabel(ui, "Universe", 48))
                .setChildSpacing(6);
        addColumn(inputs, 48, new UIIntegerBox(48, 16, modulator.channel), controlLabel(ui, "Channel", 48))
                .setChildSpacing(6);

        UI2dContainer outputs = UI2dContainer.newHorizontalContainer(HEIGHT, 4);
        final UIMeter meter1 = (UIMeter) UIMeter.newVerticalMeter(ui, modulator.output1, 12, METER_HEIGHT)
                .setX(8);
        addColumn(
                        outputs,
                        24,
                        controlLabel(ui, "Zero", 24),
                        new UIIndicator(ui, 12, 12, modulator.isZero)
                                .setTriggerable(true)
                                .setX(8))
                .setChildSpacing(4);
        addColumn(
                        ...
                        new UIIndicator(ui, 12, 12, modulator.range1active)
                                .setTriggerable(true)
                                .setX(8),
                        meter1)
                .setChildSpacing(4);
        addColumn(
                        ...
                        new UIIndicator(ui, 12, 12, modulator.range2active)
                                .setTriggerable(true)
                                .setX(8),
                        UIMeter.newVerticalMeter(ui, modulator.output2, 12, METER_HEIGHT)
                                .setX(8))
                .setChildSpacing(4);
