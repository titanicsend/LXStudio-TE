...
/**
 * Since we're dealing with a very awkwardly shaped object, it's often helpful to think of/treat
 * certain areas in terms of a rectangular prism that would encapsulate the points you're working
 * with. This class helps retrieve/represent those dimensions.
 *
 * <p>One relevant aspect to note is that the Z param which is generally referred to as depth is
 * representing what one would think of as the width if they were looking at the car from the front.
 */
...
public class Dimensions {
  ...
  public int hashCode() {
    return Objects.hash(
        minX, minY, minZ, maxX, maxY, maxZ, minXn, minYn, minZn, maxXn, maxYn, maxZn);
  }
