 ...
 *
 * <p>The rate is tied to the engine bpm and the input time value, which is usually controlled by
 * the variable speed timer associated with the speed or spin controls. (but anything with a
 * seconds.millis timer can generate rotational angles this way.)
 */
public class Rotor {
  ...
  /**
   * Sets maximum spin rate for all patterns using this rotor. Note that a Rotor object is
   * associated with a timer, which can be a VariableSpeedTimer. So "seconds" may be variable in
   * duration, and can be positive or negative.
   *
