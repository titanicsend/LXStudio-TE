...
public class TEMath {
  ...
  /** Take a normalized position (n) where 0 is 0 and n=1 is x = PI * 2 Return a 0..1 sin wave */
   ...
   *
   * <p>See https://www.desmos.com/calculator/uasacds4ra
   *
  ...
  /**
   * Built-in function from GLSL fragment shader language ported to Java Performs smooth Hermite
   * interpolation between 0 and 1
   *
   * <p>See: https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/smoothstep.xhtml
   */
  ...
  public static class EMA {
    ...
    /**
     * Create an exponential moving average, given numSamples. The number of samples averaged in an
     * EMA is estimated by 1/(1-alpha).
     *
     * @param initialAverage Starting value
    ...
    /**
     * Accumulate a new sample into the moving average Weighted by how much time has passed since
     * the last sample was added
     *
     * @param value the new sample
