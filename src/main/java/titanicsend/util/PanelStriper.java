...
public class PanelStriper {
    ...
    public static String stripe(
        ...
        if (stripingInstructions == null)
            ...
            floorPoints = newStripeFloor(
                    id, floorTransform.f0, floorTransform.f1, floorTransform.f2, stripingInstructions, gapFloorPoint);
    ...
    private static List<FloorPoint> oldStripeFloor(FloorPoint fStart, FloorPoint fMid, FloorPoint fEnd) {
    ...
    private static List<FloorPoint> newStripeFloor(
        ...
        for (int i = 0; i < numRows; i++) {
            ...
            currentPoint = new FloorPoint(
                    currentPoint.x - 1.5 * deltaX, currentPoint.z + DISTANCE_BETWEEN_PIXELS * 0.5 * Math.sqrt(3.0));
