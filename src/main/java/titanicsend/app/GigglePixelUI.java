...
public class GigglePixelUI extends UICollapsibleSection {
    ...
    public final EnumParameter<GPMode> gpMode = new EnumParameter<>("GP Mode", GPMode.OFF)
            .setDescription("Should GigglePixel listen, broadcast, or neither?");

    public GigglePixelUI(
            final LXStudio.UI ui, float width, GigglePixelListener listener, GigglePixelBroadcaster broadcaster) {
