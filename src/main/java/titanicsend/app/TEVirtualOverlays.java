...
public class TEVirtualOverlays extends LXComponent {
    ...
    public final BooleanParameter speakersVisible = new BooleanParameter("Speakers")
            .setDescription("Toggle whether speakers are visible")
            .setValue(false);

    public final BooleanParameter vertexLabelsVisible = new BooleanParameter("Vertex Labels")
            .setDescription("Toggle whether vertex labels are visible")
            .setValue(false);

    public final BooleanParameter panelLabelsVisible = new BooleanParameter("Panel Labels")
            .setDescription("Toggle whether panel labels are visible")
            .setValue(false);

    public final BooleanParameter unknownPanelsVisible = new BooleanParameter("Unk Panels")
            .setDescription("Toggle whether unknown panels are visible")
            .setValue(true);

    public final BooleanParameter opaqueBackPanelsVisible = new BooleanParameter("Backings")
            .setDescription("Toggle whether to render the back of lit panels as opaque")
            .setValue(true);

    public final CompoundParameter backingOpacity = new CompoundParameter("Backing Opacity", 1, 0, 1)
            .setUnits(Units.PERCENT_NORMALIZED)
            .setDescription("Sets the opacity of the panel backings, when On");

    public final BooleanParameter powerBoxesVisible = new BooleanParameter("Power boxes")
            .setDescription("Toggle whether to show power boxes")
            .setValue(false);

    public final BooleanParameter lasersVisible = new BooleanParameter("Lasers Visible")
            .setDescription("Toggle whether lasers are visible")
            .setValue(false);

    public final BoundedParameter laserBoxSize =
            new BoundedParameter("Laser Box Size", 400000, 100000, 755000).setDescription("Size of sound objects");
