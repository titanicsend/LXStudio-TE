...
/**
 * Tracks when we effectively change the master deck based on
 * fader value position on the mixer.
 *
 * This is important because ShowKontrol is really bad about
 * sending phrase messages when master deck changes -- we get a large
 * build up of phrase messages that causes issues with AutoVJ otherwise!
 */
