...
public class DevSwitch extends LXComponent implements LXSerializable, LX.ProjectListener {
    ...
    public final BooleanParameter lock = new BooleanParameter("Lock", true)
            .setMode(Mode.TOGGLE)
            .setDescription(
                    "When TRUE, if switch is set before a file is opened, switch will be re-applied after file open operation completes.");

    public final BooleanParameter isDev = new BooleanParameter("Developer", false)
            .setMode(Mode.TOGGLE)
            .setDescription("Developer mode: disable outputs");

    public final BooleanParameter isProduction = new BooleanParameter("Production", false)
            .setMode(Mode.TOGGLE)
    ...
    public final BooleanParameter engineLEDs = new BooleanParameter(INDENT + "LEDs", true)
            .setMode(Mode.TOGGLE)
    ...
    public final BooleanParameter engineBeacons =
            new BooleanParameter(INDENT + "Beacons", true).setMode(Mode.TOGGLE).setDescription("Beacons output");

    // DJ Lights

    public final BooleanParameter engineDJlights = new BooleanParameter(INDENT + "DJ lights", true)
            .setMode(Mode.TOGGLE)
    ...
    public final BooleanParameter midiSurfaces = new BooleanParameter("Midi Surfaces", false)
            .setMode(Mode.TOGGLE)
    ...
    public final BooleanParameter tempoSourceOSC =
            new BooleanParameter("Tempo is OSC", false).setMode(Mode.TOGGLE).setDescription("Tempo clockSource is OSC");
    ...
    private void setMidiSurfacesEnabled(boolean enabled) {
        ...
        for (LXMidiInput lmi : lx.engine.midi.inputs) {
            ...
            } else if (lmi.getName().equals(MidiNames.APC40MK2) || lmi.getName().equals(MidiNames.BOMEBOX_APC40MK2)) {
                // APC40mk2
