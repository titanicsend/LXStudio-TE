...
public class MultiplierModulator extends LXModulator implements LXOscComponent {
    ...
    public final CompoundParameter inputA = new CompoundParameter("Input A")
            .setUnits(CompoundParameter.Units.PERCENT_NORMALIZED)
            .setDescription("Map something to Input A or set manually");

    public final CompoundParameter inputB = new CompoundParameter("Input B")
            .setUnits(CompoundParameter.Units.PERCENT_NORMALIZED)
            .setDescription("Map something to Input B or set manually");

    public final CompoundParameter output = new CompoundParameter("Output")
            .setUnits(CompoundParameter.Units.PERCENT_NORMALIZED)
