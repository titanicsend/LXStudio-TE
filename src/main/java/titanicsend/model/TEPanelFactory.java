...
public class TEPanelFactory {
    public static TEPanelModel build(
        ...
        if (panelType.equals(TEPanelModel.LIT)) {
            ...
            try {
                flavor = PanelStriper.stripe(
                        id, v0, v1, v2, startVertexId, midVertexId, stripedPoints, stripingInstructions, gapPoint);
            } catch (Throwable t) {
        ...
        return new TEPanelModel(id, points, v0, v1, v2, e0, e1, e2, panelType, flavor, centroid, channelLengths, tags);
    }
}
