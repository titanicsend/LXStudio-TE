  ...
  public final EnumParameter<SolidColorSource> solidSource =
      new EnumParameter<SolidColorSource>("SolidSource", SOLID_SOURCE_DEFAULT) {
        ...
        public LXParameter reset() {
          ...
          "For a solid color: Whether to use global TE palette (preferred), or a static color"
  ...
  public final EnumParameter<TEGradient> gradient =
      (EnumParameter<TEGradient>)
          new EnumParameter<TEGradient>("Gradient", TEGradient.FULL_PALETTE)
              .setDescription(
                  "Which TEGradient to use. Full_Palette=entire, Foreground=Primary-Secondary,"
                      + " Primary=Primary-BackgroundPrimary,"
                      + " Secondary=Secondary-BackgroundSecondary")
              .setWrappable(false);
      ...
      (TEColorOffsetParameter)
          new TEColorOffsetParameter("Offset") {
            ...
            public BoundedParameter reset() {
              ...
              "Allows user variation of solid color.  If Static, adjusts hue offset. If Palette,"
                  + " adjusts normalized position within gradient.");
