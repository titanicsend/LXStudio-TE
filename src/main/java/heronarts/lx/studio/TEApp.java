...
public class TEApp extends LXStudio {
  ...
  public static class Plugin implements LXStudio.Plugin, LX.Listener, LX.ProjectListener {
    ...
    public void initialize(LX lx) {
      ...
      lx.engine.midi.registerSurface(MidiNames.BOMEBOX_APCMINIMK2, heronarts.lx.midi.surface.APCminiMk2.class);
      lx.engine.midi.registerSurface(MidiNames.BOMEBOX_APCMINIMK2_DIRECTOR, DirectorAPCminiMk2.class);
