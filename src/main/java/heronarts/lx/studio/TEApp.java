...
public class TEApp extends LXStudio {
    ...
    public static class Plugin implements LXStudio.Plugin, LX.Listener, LX.ProjectListener {
        ...
        public void initialize(LX lx) {
            ...
            Function<Class<?>, Class<LXPattern>[]> patternGetter = (Class<?> patternConfigClass) ->
            ...
            try {
                this.gpBroadcaster = new GigglePixelBroadcaster(lx, destIP, wholeModel.name, myGigglePixelID);
    ...
    private void addAllPatterns() {
        ...
        if (channel instanceof LXChannel) {
            TE.log("*** Instantiating all " + this.registry.patterns.size() + " patterns in registry to channel "
                    + channel.getLabel() + " ***");
    ...
    public static void main(String[] args) {
        ...
        LX.log("Running java " + System.getProperty("java.version")
